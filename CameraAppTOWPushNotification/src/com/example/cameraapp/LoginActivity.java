	...
	public void onCreate(Bundle savedInstanceState) {
		...
		loginButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				PostRequest.registrationId = MainActivity.regId;
				//PostRequest.password = password.getText().toString();
				...
				try {
					if(jsonReceived.getBoolean("state")){
						st.storeToken(jsonReceived.getString("authToken"));
						MainActivity.authToken = jsonReceived.getString("authToken");
						Log.i("in login activity",""+st.getToken());
