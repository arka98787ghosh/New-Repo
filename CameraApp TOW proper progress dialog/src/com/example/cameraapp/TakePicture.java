...
public class TakePicture extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		 ...
		 * stub // isGallery = true; Intent i = new Intent( Intent.ACTION_PICK,
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.open_server_gallery:
			// Toast.makeText(this, "should load gallery from server",
			// Toast.LENGTH_SHORT)
			// .show();
			mProgressDialog = ProgressDialog.show(mContext, "Processing",
					"Please Wait ...", true);
	...
	PictureCallback mPicture = new PictureCallback() {
		...
		public void onPictureTaken(byte[] data, Camera camera) {
			...
			Log.i("" + data[0], "" + data[1]);
			// bitmapRecycle(bitmap);
			// bitmap = Bitmap.createBitmap(TakePicture.width,
			// TakePicture.height,
	...
	protected void onResume() {
		...
		if (GridLayoutActivity.statusCode == 401) {
			GridLayoutActivity.statusCode = 0;
